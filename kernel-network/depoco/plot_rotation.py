...
if __name__ == "__main__":
    ...
    p_x = [0,10,20,30]
    pn_y = [1255,1464,1676,1923]
    pc_y = [1245,1374,1576,1823]
    min_y = [40,90,168,264]
    our_y = [34,74,125,204]
    ax[0].plot(p_x,pn_y, color='green',marker='x', label='PointNetVLAD',linewidth=3,markersize=8)
    ax[0].plot(p_x,pc_y, color='blue',marker='o', label='PCAN',linewidth=3,markersize=8)
    ax[0].plot(p_x,min_y, color='red',marker='v', label='MinkLoc3D',linewidth=3,markersize=8)
    ax[0].plot(p_x,our_y, color='purple',marker='+', label='Ours',linewidth=3,markersize=8)
