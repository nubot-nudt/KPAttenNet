...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=str,
        required=False,
        default='/home/yy/deep-point-map-compression-fuxian/deep-point-map-compression/depoco/config/arch/sample_net.yaml',
    ...
    input_folder=FLAGS.dataset + '/mini_val/'
